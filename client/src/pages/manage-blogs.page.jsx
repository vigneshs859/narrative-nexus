...
const ManageBlog = () => {
  ...
  return (
    <>
        <h1 className='max-md:hidden text-2xl'>Manage   Story</h1>
        <Toaster/>
        ...
        <InPageNavigaion routes={["Published Blogs", "Drafts Blogs"]} defaultActiveIndex={activeTab !== 'draft' ? 0 : 1}>
            {
                blogs == null ? <Loader/> :
                    ...
                    : <NoDataMessage message='No Published Stories Available'/>
            }
            {
                drafts == null ? <Loader/> :
                    ...
                    : <NoDataMessage message='No Draft Stories Available'/>
            }
        </InPageNavigaion>
    </>
  )
