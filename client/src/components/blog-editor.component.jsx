...
const BlogEditor = () => {
    ...
    const handlePublishEvent = () =>{
        if(!banner.length){
            return toast.error("Upload a story banner to publish it")
        }
        if(!title.length)
            return toast.error("Write story title to publish it") 
        if(textEditor.isReady){
            textEditor.save().then(data =>{
                if(data.blocks.length){
                    ...
                    return toast.error("Write Something in your story to publish it")
                }
            })
            .catch((err)=>{
                toast.error(err)
    ...
    const handleSaveDraft = (e) =>{
          ...
          if(!title.length){
            return toast.error("Write story Title before saving it as draft")
          }
