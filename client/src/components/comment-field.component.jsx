...
const CommentField = ({action, index = undefined, replyingTo = undefined, setReplying}) => {
    ...
    const handleComment = () => {
      if(!access_token){
        return toast.error("login first to leave a collaborative story")
      }

      if(!comment.length){
        return toast.error("Write something for collaborative story...")
      }
  ...
  return (
    <>
        ...
        <textarea 
            ...
            placeholder='Write a new branch story...'
