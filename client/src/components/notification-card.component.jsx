...
const NotificationCard = ({ data, index, notificationState }) => {
    ...
    const { seen, type, reply, replied_on_comment, comment, createdAt, user, blog: { _id, blog_id, title }, _id: notification_id } = data;

    // Check if personal_info is present before accessing its properties
    const { profile_img, fullname, username } = user && user.personal_info ? user.personal_info : {};
