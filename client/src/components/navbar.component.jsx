        ...
        <>
            <nav className="navbar z-50">
                ...
                <div className='flex items-center gap-3 md:gap-6 ml-auto '>
                    ...
                    {/* Chatbot navbar */}
                    <Link to='/chatbot' className='hidden md:flex items-center gap-2 link '>
    <p className="mr-2">Chatbot</p>
    <div className="flex items-center">
        <i className='fi fi-rr-chat'></i>
        {/* Add your logo here */}
        <img src="https://img.freepik.com/free-vector/cute-robot-holding-phone-with-laptop-cartoon-vector-icon-illustration-science-technology-isolated_138676-4870.jpg?w=740&t=st=1711261915~exp=1711262515~hmac=394a78b42878de0c8920ce6517d75a445522aaecbd2376e70cba80f5fe45532b" alt="Chatbot Logo" className="w-20 h-20" />
    </div>
</Link>
